...
<div class="monxao">
	...
	<!-- LẤY DỮ LIỆU SẢN PHẨM TỪ DATABASE DM3  -->
	<%
		List<produce> listSanPham = produceDAO.getListProduce2("3");
		for (produce x : listSanPham) {
			...
			out.println("<a href=\"cart?action=addtocart&code=" + x.getCode() + "&title=" + x.getTitle() + "&price="
					+ x.getPrice() + "&image=" + x.getImages() + "\">	<div class=\"btn-cart\" >");
			out.println("</div></a>");
			out.println("</div>");
			out.println("</div>");
			out.println("</div>");
