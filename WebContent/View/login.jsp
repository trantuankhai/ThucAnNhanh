		...
		<div class="login-box animated fadeInUp">
			...
			<form method="post" action="log-in" >
				...
				<br /> <label for="username">Username</label><br> <input
					...
					id="password" name="passWord" required> <br /> <input type="submit"
					name="btnAction" value="Submit" X> <br />
					<span styles="color:red;" >${fail}</span>
			</form>
			<a href="dangky.jsp"><p class="small">Đăng Ký</p></a>
		</div>
	</div>
